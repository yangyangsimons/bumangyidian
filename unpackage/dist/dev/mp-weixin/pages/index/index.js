...
const _sfc_main = {
  __name: "index",
  setup(__props) {
    const showAd = common_vendor.ref(true);
    ...
    const adNav = (adUrl) => {
      common_vendor.index.__f__("log", "at pages/index/index.vue:148", "广告链接......:", adUrl);
    ...
    const toggleSystemModel = async () => {
      ...
      if (isTogglingModel.value) {
        common_vendor.index.__f__("log", "at pages/index/index.vue:315", "切换模式操作进行中，请勿重复点击");
        common_vendor.index.showToast({
          title: "操作进行中，请稍候",
          icon: "none"
        });
      ...
      try {
        ...
        common_vendor.index.__f__("log", "at pages/index/index.vue:331", `切换到${currentModel.value}`);
        audioPlayerStore.reportCurrentProgress();
        audioPlayerStore.stopAllAudio();
        common_vendor.index.__f__("log", "at pages/index/index.vue:336", "停止并清空所有音频队列");
        barrageStore.clearMessages();
        common_vendor.index.__f__("log", "at pages/index/index.vue:338", "清空消息列表");
        ...
        await wsStore.close();
        common_vendor.index.__f__("log", "at pages/index/index.vue:379", "模式切换WebSocket连接已关闭");
        await new Promise((resolve) => setTimeout(resolve, 1e3));
        try {
          await wsStore.connect();
          common_vendor.index.__f__("log", "at pages/index/index.vue:387", "切换模式的socket重新连接成功");
          await new Promise((resolve) => setTimeout(resolve, 1e3));
          if (currentModel.value === "金种子杯模式") {
            ...
            common_vendor.index.__f__("log", "at pages/index/index.vue:400", "模式切换消息发送成功");
          } else {
            ...
            common_vendor.index.__f__("log", "at pages/index/index.vue:409", "模式切换消息发送成功");
          }
          common_vendor.index.showToast({
            title: "模式切换成功",
            icon: "success",
          ...
          common_vendor.index.__f__("error", "at pages/index/index.vue:418", "WebSocket操作失败:", error);
          common_vendor.index.showToast({
            title: "切换失败，请稍后再试",
            icon: "none"
          });
        ...
        common_vendor.index.__f__("error", "at pages/index/index.vue:434", "切换模式过程中出错:", error);
        common_vendor.index.showToast({
          title: "切换失败，请稍后再试",
          icon: "none"
        });
    ...
    const handleSubmit = (message) => {
      common_vendor.index.__f__("log", "at pages/index/index.vue:445", message, "handleSubmit");
    };
    const fetchSystemConfig = async () => {
      try {
        const res = await utils_request.request(`${utils_config.baseUrl}/system/get_system_setting`, "GET");
        common_vendor.index.__f__("log", "at pages/index/index.vue:452", "获取系统配置", res);
        ...
        common_vendor.index.__f__("error", "at pages/index/index.vue:479", "获取系统配置失败:", error);
      }
    };
    common_vendor.onShow(async () => {
      ...
      try {
        common_vendor.index.__f__("log", "at pages/index/index.vue:499", "主页面显示");
        adList.value = [
          {
            // pic_url: '../../static/festival-bg.png',
            pic_url: "https://oss-5gradio-school-public.oss-cn-shenzhen.aliyuncs.com/notify_pic%2F20250626083746_%E5%BE%AE%E4%BF%A1%E5%9B%BE%E7%89%87_2025-06-26_083603_491.png",
    ...
    common_vendor.onShareAppMessage(() => {
      common_vendor.index.__f__("log", "at pages/index/index.vue:642", "onShareAppMessage......");
      return {
        title: `不芒一点，陪你世界加一点`,
    ...
    common_vendor.onShareTimeline(() => {
      common_vendor.index.__f__("log", "at pages/index/index.vue:650", "onShareTimeline......");
      return {
        title: `不芒一点，陪你世界加一点`
      };
    });
